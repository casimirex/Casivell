...
// The stable shell: the entry, the engine, and the PWA metadata. The hashed
// JS/CSS bundles are cached at runtime on first fetch, so they need no listing
// here — a new build's hashes are picked up without editing this file.
const SHELL = [
  "./",
  "./index.html",
  "./casivell_wasm.wasm",
